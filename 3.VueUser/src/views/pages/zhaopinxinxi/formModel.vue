	...
	<div class="app-contain" :style='{"padding":"20px 0px","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"20px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">工作岗位</div>
					<div  class="info_text" >{{detail.gongzuogangwei}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">工作城市</div>
					<div  class="info_text" >{{detail.gongzuochengshi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">招聘批次</div>
					<div  class="info_text" >{{detail.zhaopinpici}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">招聘时间</div>
					<div  class="info_text" >{{detail.zhaopinshijian}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">招聘届数</div>
					<div  class="info_text" >{{detail.zhaopinjieshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">岗位要求</div>
					<div  class="info_text" >{{detail.gangweiyaoqiu}}</div>
				</div>
				<div class="info_item">
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.gongsimingcheng
