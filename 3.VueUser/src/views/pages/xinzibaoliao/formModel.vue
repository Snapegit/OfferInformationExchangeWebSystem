	...
	<div class="app-contain" :style='{"padding":"20px 0px","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"20px","flexWrap":"wrap","background":"#fff","display":"flex","width":"64%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">公司负责人</div>
					<div  class="info_text" >{{detail.xingming}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">公司岗位</div>
					<div  class="info_text" >{{detail.gongsigangwei}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">所在城市</div>
					<div  class="info_text" >{{detail.suozaichengshi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">薪资构成</div>
					<div  class="info_text" >{{detail.xinzigoucheng}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">年薪/万</div>
					<div  class="info_text" >{{detail.nianxin}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">招聘类别</div>
					<div  class="info_text" >{{detail.zhaopinleibie}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">行业</div>
					<div  class="info_text" >{{detail.xingye}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">爆料详情</div>
					<div  class="info_text" >{{detail.baoliaoxiangqing}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('xinzibaoliao','审核')" type="warning" @click="approvalClick()">审核</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('xinzibaoliao','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('xinzibaoliao','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('xinzibaoliao','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.baoliaogongsimingcheng
	...
	const collectClick = (type) => {
		if (type == 1 && !collectType.value) {
			let params = {
				name: title.value,
				picture: bannerList.value[0],
				inteltype: detail.value.xingyeleixing,
				refid: detail.value.id,
				type: type,
				tablename: tableName,
				userid: context?.$toolUtil.storageGet('userid')
