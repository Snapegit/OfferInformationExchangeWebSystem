		...
		<div class="app-contain">
			<el-form class="userinfo_form" ref="userinfoFormRef" :model="form" label-width="$template2.back.add.form.base.labelWidth">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="头像" prop="touxiang">
							<uploads
								...
								@change="gongzuorenyuantouxiangUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="性别" prop="xingbie">
							<el-select 
								...
								placeholder="请选择性别"
								>
								<el-option v-for="item in gongzuorenyuanxingbieLists" :label="item" :value="item"></el-option>
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="24">
						<el-form-item label="所属部门" prop="suoshubumen">
							<el-input class="list_inp" v-model="user.suoshubumen"  placeholder="所属部门" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="24">
...
<script setup>
	...
	const tableName = ref('gongzuorenyuan')
	const user = ref({})
	const gongzuorenyuanxingbieLists = ref([])
	const init = () => {
		gongzuorenyuanxingbieLists.value = "男,女".split(',')
	}
	const gongzuorenyuantouxiangUploadSuccess=(fileUrls)=> {
