				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="所属部门" prop="suoshubumen">
							<el-input class="list_inp" v-model="form.suoshubumen" placeholder="所属部门"
								 type="text" 								:readonly="!isAdd||disabledForm.suoshubumen?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='suoshubumen'){
					form.value.suoshubumen = row[x];
					disabledForm.value.suoshubumen = true;
					continue;
				}
				if(x=='lianxifangshi'){
